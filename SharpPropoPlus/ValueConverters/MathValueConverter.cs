...
{
    //MathValueConverter by: https://rachel53461.wordpress.com/2011/08/20/the-math-converter/

    /// <summary>
    /// <para>Does a math equation on the bound value.</para>
    /// <para>Use @VALUE in your mathEquation as a substitute for bound value</para>
    /// <para>Operator order is parenthesis first, then Left-To-Right (no operator precedence)</para>
    /// </summary>
