...
namespace SharpPropoPlus.Decoder
{
  public class JoystickInteraction: IDisposable
  {
    ...
    private int Map2Nibble(int map, int i)
    {
      return ((map & (0xF << (4 * (7 - i)))) >> (4 * (7 - i))) & 0xF;
    }

    private void SetDefaultBtnMap(ref int[] btnMap)
    {
    ...
    /// <para><see cref="Constants.HID_USAGE_X"/></para>
    /// <para><see cref="Constants.HID_USAGE_Y"/></para>
    /// <para><see cref="Constants.HID_USAGE_Z"/></para>
    /// <para><see cref="Constants.HID_USAGE_RX"/></para>
    /// <para><see cref="Constants.HID_USAGE_RY"/></para>
    /// <para><see cref="Constants.HID_USAGE_RZ"/></para>
    /// <para><see cref="Constants.HID_USAGE_SL0"/></para>
    /// <para><see cref="Constants.HID_USAGE_SL1"/></para>
    /// <para><see cref="Constants.HID_USAGE_WHL"/></para>
    /// </summary>
    ...
    private bool SetBtnDelayed(ref vJoy.JoystickState joystickState, bool btnValue, int nBtn)
    {
